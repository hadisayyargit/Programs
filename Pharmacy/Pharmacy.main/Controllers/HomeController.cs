...
namespace pharmacy.Controllers
{
    public class HomeController : Controller
    {
        public ActionResult Index()
        {
            ...
            ViewBag.Message = "دکتر شهبازی";
            ViewBag.GalleryList = Directory.GetFiles(Server.MapPath("~/assets/images/gallery/")).ToList();
            ViewBag.DrugstoreList = Directory.GetFiles(Server.MapPath("~/assets/images/drugstore/")).ToList();
