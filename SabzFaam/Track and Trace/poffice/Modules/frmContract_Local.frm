VERSION 5.00
Begin VB.Form frmContract_Local 
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "ﬁ—«—œ«œÂ«Ì œ«Œ·Ì"
   ClientHeight    =   6945
   ClientLeft      =   1095
   ClientTop       =   240
   ClientWidth     =   8835
   ...
   Begin VB.Frame fraMaster 
      ...
      Begin VB.PictureBox picButtons 
         ...
         Begin VB.CommandButton cmdLast 
            ...
            Left            =   480
            MaskColor       =   &H00FFFFFF&
            Picture         =   "frmContract_Local.frx":0000
            TabIndex        =   14
            Top             =   120
            UseMaskColor    =   -1  'True
            Width           =   375
         ...
         Begin VB.CommandButton cmdPrevious 
            ...
            Left            =   4680
            MaskColor       =   &H00FFFFFF&
            Picture         =   "frmContract_Local.frx":0342
            TabIndex        =   13
            Top             =   120
            UseMaskColor    =   -1  'True
            Width           =   375
         ...
         Begin VB.CommandButton cmdFirst 
            ...
            Left            =   5040
            MaskColor       =   &H00FFFFFF&
            Picture         =   "frmContract_Local.frx":042C
            TabIndex        =   15
            Top             =   120
            UseMaskColor    =   -1  'True
            Width           =   375
         ...
         Begin VB.CommandButton cmdClose 
            ...
            Height          =   735
            Left            =   120
            Picture         =   "frmContract_Local.frx":086E
            RightToLeft     =   -1  'True
            Style           =   1  'Graphical
            TabIndex        =   22
            Top             =   600
         ...
         Begin VB.CommandButton cmdSearch 
            ...
            Height          =   735
            Left            =   960
            Picture         =   "frmContract_Local.frx":0B78
            RightToLeft     =   -1  'True
            Style           =   1  'Graphical
            TabIndex        =   21
            Top             =   600
         ...
         Begin VB.CommandButton cmdNew 
            ...
            Height          =   735
            Left            =   4980
            Picture         =   "frmContract_Local.frx":0E82
            RightToLeft     =   -1  'True
            Style           =   1  'Graphical
            TabIndex        =   16
            Top             =   600
         ...
         Begin VB.CommandButton cmdEdit 
            ...
            Height          =   735
            Left            =   4170
            Picture         =   "frmContract_Local.frx":12C4
            RightToLeft     =   -1  'True
            Style           =   1  'Graphical
            TabIndex        =   17
            Top             =   600
         ...
         Begin VB.CommandButton cmdCancel 
            ...
            Height          =   735
            Left            =   1740
            Picture         =   "frmContract_Local.frx":1706
            RightToLeft     =   -1  'True
            Style           =   1  'Graphical
            TabIndex        =   20
            Top             =   600
         ...
         Begin VB.CommandButton cmdUpdate 
            ...
            Height          =   735
            Left            =   2550
            Picture         =   "frmContract_Local.frx":1B48
            RightToLeft     =   -1  'True
            Style           =   1  'Graphical
            TabIndex        =   19
            Top             =   600
         ...
         Begin VB.CommandButton cmdNext 
            ...
            Left            =   840
            MaskColor       =   &H00FFFFFF&
            Picture         =   "frmContract_Local.frx":1F8A
            TabIndex        =   12
            Top             =   120
            UseMaskColor    =   -1  'True
            Width           =   375
         ...
         Begin VB.CommandButton cmdDelete 
            ...
            Height          =   735
            Left            =   3360
            Picture         =   "frmContract_Local.frx":22CC
            RightToLeft     =   -1  'True
            Style           =   1  'Graphical
            TabIndex        =   18
            Top             =   600
   ...
   End
End
Attribute VB_Name = "frmContract_Local"
...
Private Sub cmdNew_Click()
    ...
    Call G_BoxesEmpty(Me)
    G_PrimaryRs.AddNew
    txtBegin.Text = G_CurrentDate
    txtEnd.Text = G_CurrentDate
    txtCno.SetFocus
    Exit Sub
...
Private Sub cmdUpdate_Click()
    ...
    If G_BoxesValidate(Me) = True Then
        If Val(txtDetail.Text) > 15 Then
            Call G_ShowMsg("Õœ«ﬂÀ— œ—’œ  Œ›Ì› 15% „Ìù»«‘œ!", vbOKOnly, G_exclamation)
            Exit Sub
        End If
        key1 = txtCno
        G_PrimaryRs!Cno = txtCno.Text
        G_PrimaryRs!Caption = txtCaption.Text
        G_PrimaryRs!Fare = Val(txtFare.Text)
        G_PrimaryRs!Detail = txtDetail.Text
        G_PrimaryRs!stakeholder = Trim(txtStakeholder.Text)
        G_PrimaryRs!BeginDate = txtBegin.Text
        G_PrimaryRs!ExpireDate = txtEnd.Text
        
        If rdoNew.Value = True Then
            G_PrimaryRs!Contract_type = 0
        Else
            G_PrimaryRs!Contract_type = 1
        End If
...
Private Sub Form_Load()
    ...
    G_MyQuery = "SELECT * From tblLocalContracts ORDER BY Cno"
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    If (Not G_PrimaryRs.EOF) Then
        If G_PrimaryRs.EditMode <> adEditNone Then G_PrimaryRs.CancelUpdate
    End If
    If G_PrimaryRs.State = 1 Then G_PrimaryRs.Close
End Sub
