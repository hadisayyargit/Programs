...
{
    public class clsAccidentKind
    {
        #region static

        public static DataView GetAllAccidentKinds()
        {
        ...
        public string dbInsert()
        {
            ...
            try
            {
                ...
                strRes = dpHadiData.ExecuteStoredProcedure(dpHadiData.m_PrimaryConnection, "Rws_Sp_Ins_AccidentKind", objSqlParameters);
            }
            catch (Exception ex)
            {
                strRes = ex.Message;
        ...
        public string dbUpdate()
        {
            ...
            try
            {
                ...
                strRes = dpHadiData.ExecuteStoredProcedure(dpHadiData.m_PrimaryConnection, "Rws_SP_Upd_AccidentKind", objSqlParameters);
            }
            catch (Exception ex)
            {
                strRes = ex.Message;
        ...
        public string dbDelete()
        {
            ...
            try
            {
                ...
                strRes = dpHadiData.ExecuteStoredProcedure(dpHadiData.m_PrimaryConnection, "Rws_SP_Del_AccidentKind", objSqlParameters);
            }
            catch (Exception ex)
            {
                strRes = ex.Message;
        ...
        public string AccidentKindName
        {
            get
            {
                return (m_strName);
