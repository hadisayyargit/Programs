...
{
	public class arvReport4_1 : ActiveReport
	{
		int intPkEarlyAccident;
		ReportID reportID;

		public arvReport4_1(int intPkEarlyAccident, ReportID reportID)
		{
			InitializeReport();
		...
		private void arvReport4_1_DataInitialize(object sender, System.EventArgs eArgs)
		{
		...
		{
			this.LoadLayout(this.GetType(), "RWAS.WinUI.Reports.arvReport4_1.rpx");
			...
			this.DataInitialize += new System.EventHandler(this.arvReport4_1_DataInitialize);
		}
