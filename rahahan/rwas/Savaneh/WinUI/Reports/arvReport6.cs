...
{
	public class arvReport6 : ActiveReport
	{
		int intPkEarlyAccident;
		ReportID reportID;

		public arvReport6(int intPkEarlyAccident, ReportID reportID)
		{
			InitializeReport();
		...
		private void arvReport6_DataInitialize(object sender, System.EventArgs eArgs)
		{
		...
		{
			this.LoadLayout(this.GetType(), "RWAS.WinUI.Reports.arvReport6.rpx");
			...
			this.Label6 = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[2]));
			...
			this.TextBox = ((DataDynamics.ActiveReports.TextBox)(this.PageHeader.Controls[8]));
			this.TextBox1 = ((DataDynamics.ActiveReports.TextBox)(this.PageHeader.Controls[9]));
			this.TextBox2 = ((DataDynamics.ActiveReports.TextBox)(this.PageHeader.Controls[10]));
			...
			this.TextBox41 = ((DataDynamics.ActiveReports.TextBox)(this.PageHeader.Controls[14]));
			this.TextBox3 = ((DataDynamics.ActiveReports.TextBox)(this.Detail.Controls[0]));
			this.Line8 = ((DataDynamics.ActiveReports.Line)(this.Detail.Controls[1]));
			this.Line9 = ((DataDynamics.ActiveReports.Line)(this.Detail.Controls[2]));
			this.TextBox5 = ((DataDynamics.ActiveReports.TextBox)(this.Detail.Controls[3]));
			this.Line11 = ((DataDynamics.ActiveReports.Line)(this.Detail.Controls[4]));
			this.TextBox4 = ((DataDynamics.ActiveReports.TextBox)(this.PageFooter.Controls[0]));
			this.Label1 = ((DataDynamics.ActiveReports.Label)(this.PageFooter.Controls[1]));
			this.Line4 = ((DataDynamics.ActiveReports.Line)(this.PageFooter.Controls[2]));
			this.Line5 = ((DataDynamics.ActiveReports.Line)(this.PageFooter.Controls[3]));
			this.Line6 = ((DataDynamics.ActiveReports.Line)(this.PageFooter.Controls[4]));
			this.Line7 = ((DataDynamics.ActiveReports.Line)(this.PageFooter.Controls[5]));
			// Attach Report Events
			this.DataInitialize += new System.EventHandler(this.arvReport6_DataInitialize);
		}
