...
{
	public class arvReport11 : ActiveReport
	{
		int intPkEarlyAccident;
		ReportID reportID;

		public arvReport11(int intPkEarlyAccident, ReportID reportID)
		{
			InitializeReport();
		...
		private void arvReport11_DataInitialize(object sender, System.EventArgs eArgs)
		{
		...
		{
			this.LoadLayout(this.GetType(), "RWAS.WinUI.Reports.arvReport11.rpx");
			...
			this.Line3 = ((DataDynamics.ActiveReports.Line)(this.Detail.Controls[1]));
			...
			this.Label8 = ((DataDynamics.ActiveReports.Label)(this.PageFooter.Controls[0]));
			...
			this.Line11 = ((DataDynamics.ActiveReports.Line)(this.PageFooter.Controls[3]));
			this.Line12 = ((DataDynamics.ActiveReports.Line)(this.PageFooter.Controls[4]));
			this.TextBox7 = ((DataDynamics.ActiveReports.TextBox)(this.PageFooter.Controls[5]));
			// Attach Report Events
			this.DataInitialize += new System.EventHandler(this.arvReport11_DataInitialize);
		}
