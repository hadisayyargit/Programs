...
{
	public class arvReport13 : ActiveReport
	{
		int intPkEarlyAccident;
		ReportID reportID;

		public arvReport13(int intPkEarlyAccident, ReportID reportID)
		{
			InitializeReport();
		...
		private void arvReport13_DataInitialize(object sender, System.EventArgs eArgs)
		{
		...
		{
			this.LoadLayout(this.GetType(), "RWAS.WinUI.Reports.arvReport13.rpx");
			this.PageHeader = ((DataDynamics.ActiveReports.PageHeader)(this.Sections["PageHeader"]));
			this.Detail = ((DataDynamics.ActiveReports.Detail)(this.Sections["Detail"]));
			this.PageFooter = ((DataDynamics.ActiveReports.PageFooter)(this.Sections["PageFooter"]));
			this.Label = ((DataDynamics.ActiveReports.Label)(this.PageHeader.Controls[0]));
			this.Line4 = ((DataDynamics.ActiveReports.Line)(this.PageHeader.Controls[1]));
			this.Line5 = ((DataDynamics.ActiveReports.Line)(this.PageHeader.Controls[2]));
			this.Line6 = ((DataDynamics.ActiveReports.Line)(this.PageHeader.Controls[3]));
			...
			this.Line8 = ((DataDynamics.ActiveReports.Line)(this.PageHeader.Controls[6]));
			this.Line7 = ((DataDynamics.ActiveReports.Line)(this.PageHeader.Controls[7]));
			this.TextBox41 = ((DataDynamics.ActiveReports.TextBox)(this.PageHeader.Controls[8]));
			this.Line1 = ((DataDynamics.ActiveReports.Line)(this.Detail.Controls[0]));
			this.Line9 = ((DataDynamics.ActiveReports.Line)(this.Detail.Controls[1]));
			this.TextBox = ((DataDynamics.ActiveReports.TextBox)(this.Detail.Controls[2]));
			this.TextBox2 = ((DataDynamics.ActiveReports.TextBox)(this.Detail.Controls[3]));
			this.Line = ((DataDynamics.ActiveReports.Line)(this.Detail.Controls[4]));
			this.Line2 = ((DataDynamics.ActiveReports.Line)(this.Detail.Controls[5]));
			this.TextBox1 = ((DataDynamics.ActiveReports.TextBox)(this.PageFooter.Controls[0]));
			this.Label8 = ((DataDynamics.ActiveReports.Label)(this.PageFooter.Controls[1]));
			this.Line3 = ((DataDynamics.ActiveReports.Line)(this.PageFooter.Controls[2]));
			this.Line10 = ((DataDynamics.ActiveReports.Line)(this.PageFooter.Controls[3]));
			this.Line11 = ((DataDynamics.ActiveReports.Line)(this.PageFooter.Controls[4]));
			this.Line12 = ((DataDynamics.ActiveReports.Line)(this.PageFooter.Controls[5]));
			// Attach Report Events
			this.DataInitialize += new System.EventHandler(this.arvReport13_DataInitialize);
		}
