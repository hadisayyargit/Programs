...
{
    public partial class frmEffective : Form
    {
        public frmEffective()
        {
            InitializeComponent();
        ...
        private void RefreshData()
        {
            ...
            m_dvMaster = clsAccidentEffective.GetAllAccidentEffectives();
        ...
        {
            string strRes = "";
            clsAccidentEffective objAccidentEffective = new clsAccidentEffective();

            objAccidentEffective.AccidentEffectiveCode = byte.Parse(txtCode.Text);
            objAccidentEffective.AccidentEffectiveName = txtName.Text;

            strRes = objAccidentEffective.dbInsert();
            if (strRes == "")
        ...
        void UpdateData()
        {
            ...
            strRes = objAccidentEffective.dbUpdate();
            if (strRes == "")
        ...
        void deleteData(byte nAccidentEffectiveCode)
        {
            string strRes = "";
            clsAccidentEffective objAccidentEffective = new clsAccidentEffective();

            objAccidentEffective.AccidentEffectiveCode = nAccidentEffectiveCode;

            try
            {
                strRes = objAccidentEffective.dbDelete();
            }
        ...
        private void frmEffective_Load(object sender, EventArgs e)
        {
            Program.m_PrgMod = Program.PrgMod.Normal;
            RefreshData();
