	...
	internal class CConnectionPooling
	{
		...
		public static SqlConnection GetApplicationConnection(string Server, int Port, string Database)
		{
			try
			{
				...
				if (Port > 0)
				{
					if ((CConnectionPooling.ocApplicationConnection == null) || (CConnectionPooling.ocApplicationConnection.ConnectionString == string.Empty))
					{
                        textArray1 = new string[9] { "Server = ", Server, ",", Port.ToString(), " ; Network Library = DBMSSOCN; initial catalog = ", Database, " ; Workstation id= ", Environment.MachineName, "; user id = " + CAccessControl.Username + "; password = " + CAccessControl.Password + ";Connect Timeout=600" };
						text1 = string.Concat(textArray1);
						CConnectionPooling.ocApplicationConnection = new SqlConnection(text1);
					}
				}
				...
				{
                    textArray1 = new string[7] { "Server = ", Server, " ;initial catalog = ", Database, " ; Workstation id= ", Environment.MachineName, "; user id = " + CAccessControl.Username + "; password = " + CAccessControl.Password + ";Connect Timeout=600" };
					text1 = string.Concat(textArray1);
					CConnectionPooling.ocApplicationConnection = new SqlConnection(text1);
				}
			}
		...
		public static SqlConnection GetApplicationConnection(string Server, int Port, string Database, string UserId, string Password)
		{
			try
			{
				...
				if (Port > 0)
				{
					if ((CConnectionPooling.ocApplicationConnection == null) || (CConnectionPooling.ocApplicationConnection.ConnectionString == string.Empty))
					{
                        textArray1 = new string[12] { "Server = ", Server, ",", Port.ToString(), " ; Network Library = DBMSSOCN; initial catalog = ", Database, " ; Connect Timeout=600;Workstation id= ", Environment.MachineName, "; User ID = ", UserId, ";Password = ", Password };
						text1 = string.Concat(textArray1);
						CConnectionPooling.ocApplicationConnection = new SqlConnection(text1);
					}
				}
				...
				{
                    textArray1 = new string[10] { "Server = ", Server, " ;initial catalog = ", Database, " ;Connect Timeout=600; Workstation id= ", Environment.MachineName, "; User ID = ", UserId, ";Password = ", Password };
					text1 = string.Concat(textArray1);
					CConnectionPooling.ocApplicationConnection = new SqlConnection(text1);
				}
			}
		...
		public static SqlConnection GetConnection(string Server, int Port, string Database)
		{
			...
			try
			{
				...
				if (Port > 0)
				{
                    textArray1 = new string[9] { "Server = ", Server, ",", Port.ToString(), " ; Network Library = DBMSSOCN; initial catalog = ", Database, "; Connect Timeout=600; Workstation id= ", Environment.MachineName, "; user id = " + CAccessControl.Username + "; password = " + CAccessControl.Password + ";" };
					text1 = string.Concat(textArray1);
