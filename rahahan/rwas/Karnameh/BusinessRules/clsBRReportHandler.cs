...
namespace RWAS.BusinessRules
{
	...
	public class clsBRReportHandler
	{
		...
		private DS_Rep_WorkBookPersonelAccident ocDS_Rep_WorkBookPersonelAccident;
		private DS_Rep_WorkBookPersonelBodilyMentalStatus ocDS_Rep_WorkBookPersonelBodilyMentalStatus;
		
		private DS_Rep_WorkBook_ScoreChartRegion ocDS_Rep_WorkBook_ScoreChartRegion;
		private DS_Rep_WorkBook_ScoreChartJob ocDS_Rep_WorkBook_ScoreChartJob;
		private DS_Rep_WorkBook_ScoreChartEmployeeStatus ocDS_Rep_WorkBook_ScoreChartEmployeeStatus;
		private DS_Rep_WorkBook_ScoreChartStudyStatus ocDS_Rep_WorkBook_ScoreChartStudyStatus;
		...
		#region DS_Rep_Survey
		//*********************************************************************
		/// <summary>
		/// Method Name : SearchDataSurvey
		/// Called By : FrmActiveReport
		/// Date       : 10/2/2007
		/// </summary>
		/// <param name="strFromSurveyDate"></param>
		/// <param name="strToSurveyDate"></param>
		/// <param name="shrSurveyMajorItem"></param>
		/// <param name="shrRegion"></param>
		/// <param name="intSurveyItem"></param>
		/// <param name="intSourceStation"></param>
		/// <param name="intDestinationStation"></param>
		/// <param name="shrSurveyResult"></param>
		/// <param name="strDescription"></param>
		/// <returns></returns>
		/// *********************************************************************
		public DS_Rep_Survey SearchDataSurvey(
			int intRepID,
			string strFromSurveyDate, 
			string strToSurveyDate,
			short shrRegion,
			int intSourceStation,
			int intDestinationStation,
			short shrSurveyMajorItem,
			int intSurveyItem,
			short shrSurveyResult,
			string strDescription
			)
		{
			if (   intRepID == (int)enumRepKind.Rep_Survey)
			{
				try 
				{
					ocDS_Rep_Survey = objDAReport.QuerySurvey(strFromSurveyDate, strToSurveyDate, shrRegion, intSourceStation, intDestinationStation, shrSurveyMajorItem, intSurveyItem, shrSurveyResult, strDescription);

					return ocDS_Rep_Survey;
				}
				catch( Exception ocException)
				{
					if (ocException is System.Data.SqlClient.SqlException)
		...
		#endregion Rep_Survey

		#region DS_Rep_SurveyMonthy
		//*********************************************************************
		/// <summary>
		/// Method Name : SearchDataSurveyMonthy
		/// Called By : FrmActiveReport
		/// Date       : 30/2/2007
		/// </summary>
		/// <param name="intRepID"></param>
		/// <param name="strFromYear"></param>
		/// <param name="strToYear"></param>
		/// <param name="strFromMonth"></param>
		/// <param name="strToMonth"></param>
		/// <param name="shrRegion"></param>
		/// <returns></returns>
		/// *********************************************************************
		public DS_Rep_SurveyMonthy SearchDataSurveyMonthy(
			int intRepID,
			string strFromYear, 
			string strToYear,
			string strFromMonth, 
		...
		{
			if (   intRepID == (int)enumRepKind.Rep_SurveyMonthy)
			{
				try 
				{
					ocDS_Rep_SurveyMonthy = objDAReport.QuerySurveyMonthy(strFromMonth, strToYear, strFromMonth, strToMonth, shrRegion);

					return ocDS_Rep_SurveyMonthy;
				}
				catch( Exception ocException)
				{
					if (ocException is System.Data.SqlClient.SqlException)
		...
		#endregion Rep_SurveyMonthy

		#region DS_Rep_Operation
		//*********************************************************************
		/// <summary>
		/// Method Name : SearchDataOperation
		/// Called By : FrmActiveReport
		/// Date       : 10/2/2007
		/// </summary>
		/// <param name="intRepID"></param>
		/// <param name="intUniqueCode"></param>
		/// <param name="strFromEmployeeDate"></param>
		/// <param name="strToEmployeeDate"></param>
		/// <param name="strContractor"></param>
		/// <param name="intEmployeeStatus"></param>
		/// <param name="intStudyStatus"></param>
		/// <param name="intOrgUnit"></param>
		/// <param name="strJob"></param>
		/// <returns></returns>
		/// *********************************************************************
        public DS_Rep_Operation SearchDataOperation(
            int intRepID,
                        string[] arrayRegion,
            int intUniqueCode,
            string strFromEmployeeDate,
            string strToEmployeeDate,
            string[] arraySubContractor,
            string[] arrayEmployeeStatus,
            string[] arrayStudyStatus,
            string[] arrayOrgUnit,
            string[] arrayJob

            )
        {
            if (intRepID == (int)enumRepKind.Rep_WorkBook_Operation
                || intRepID == (int)enumRepKind.Rep_WorkBook)
            {
                try
                {
                    ocDS_Rep_Operation = objDAReport.QueryOperation(arrayRegion, intUniqueCode, strFromEmployeeDate, strToEmployeeDate, arraySubContractor, arrayEmployeeStatus, arrayStudyStatus, arrayOrgUnit, arrayJob);

                    return ocDS_Rep_Operation;
                }
                catch (Exception ocException)
                {
                    if (ocException is System.Data.SqlClient.SqlException)
            ...
            )
        {
                ...
                )
            {
                try
                {
                    ...
                    ocDS_Rep_Operation = objDAReport.QueryOperation(new string[] { "0" }, intUniqueCode, "", "", new string[] { "0" }, new string[] { "0" }, new string[] { "0" }, new string[] { "0" }, new string[] { "" });
		...
		#endregion Rep_Operation

		#region DS_Rep_Personel


		//*********************************************************************
		/// <summary>
		/// Method Name : SearchDataPersonel
		/// Called By : FrmActiveReport
		/// Date       : 10/2/2007
		/// </summary>
		/// <param name="intRepID"></param>
		...
		/// <returns></returns>
		/// *********************************************************************
		public DS_Rep_Personel SearchDataPersonel(
			int intRepID,
            string[] arrayRegion,
            int intUniqueCode,
            string strFromEmployeeDate,
			...
			)
		{
			if (intRepID == (int)enumRepKind.Rep_WorkBook)
			{
				try 
				{
                    ocDS_Rep_Personel = objDAReport.QueryPersonel(arrayRegion, intUniqueCode, strFromEmployeeDate, strToEmployeeDate, arraySubContractor, arrayEmployeeStatus, arrayStudyStatus, arrayOrgUnit, arrayJob);

					return ocDS_Rep_Personel;
				}
				catch( Exception ocException)
				{
					if (ocException is System.Data.SqlClient.SqlException)
		...
		#endregion Rep_Personel

		#region DS_Rep_Personel_BriefInfo
		//*********************************************************************
		/// <summary>
		/// Method Name : SearchDataPersonel_BriefInfo
		/// Called By : FrmActiveReport
		/// Date       : 10/2/2007
		/// </summary>
		/// <param name="intRepID"></param>
		...
		/// <returns></returns>
		/// *********************************************************************
		public DS_Rep_Personel SearchDataPersonel_BriefInfo(
			int intRepID,
			byte bytRegion,
			int intUniqueCode,
			string strFromEmployeeDate,
			...
			)
		{
			if (intRepID == (int)enumRepKind.Rep_WorkBook)
			{
				try 
				{
					ocDS_Rep_Personel = objDAReport.QueryPersonel_BriefInfo(bytRegion, intUniqueCode, strFromEmployeeDate, strToEmployeeDate, intSubContractor, intEmployeeStatus, intStudyStatus, intOrgUnit, strJob);
		...
		#endregion Rep_Personel_BriefInfo

		#region DS_Rep_PrefermentHistory
		//*********************************************************************
		/// <summary>
		/// Method Name : SearchDataPrefermentHistory
		/// Called By : FrmActiveReport
		/// Date       : 10/2/2007
		/// </summary>
		/// <param name="intRepID"></param>
		...
		/// <returns></returns>
		/// *********************************************************************
		public DS_Rep_PrefermentHistory SearchDataPrefermentHistory(
			int intRepID,
			byte bytRegion,
			int intUniqueCode,
			string strFromEmployeeDate,
			...
			)
		{
			if (intRepID == (int)enumRepKind.Rep_WorkBook)
			{
				try 
				{
					ocDS_Rep_PrefermentHistory = objDAReport.QueryPrefermentHistory(bytRegion, intUniqueCode, strFromEmployeeDate, strToEmployeeDate, intSubContractor, intEmployeeStatus, intStudyStatus, intOrgUnit, strJob);

					return ocDS_Rep_PrefermentHistory;
				}
				catch( Exception ocException)
				{
					if (ocException is System.Data.SqlClient.SqlException)
		...
		#endregion Rep_PrefermentHistory
		...
		#region DS_Rep_Chastise
		//*********************************************************************
		/// <summary>
		/// Method Name : SearchDataChastise
		/// Called By : FrmActiveReport
		/// Date       : 10/2/2007
		/// </summary>
		/// <param name="intRepID"></param>
		...
		/// <returns></returns>
		/// *********************************************************************
		public DS_Rep_Chastise SearchDataChastise(
			int intRepID,
			byte bytRegion,
			int intUniqueCode,
			string strFromEmployeeDate,
			...
			)
		{
			if (intRepID == (int)enumRepKind.Rep_WorkBook)
			{
				try 
				{
					ocDS_Rep_Chastise = objDAReport.QueryChastise(bytRegion, intUniqueCode, strFromEmployeeDate, strToEmployeeDate, intSubContractor, intEmployeeStatus, intStudyStatus, intOrgUnit, strJob);

					return ocDS_Rep_Chastise;
				}
				catch( Exception ocException)
				{
					if (ocException is System.Data.SqlClient.SqlException)
		...
		#endregion Rep_Chastise

		#region DS_Rep_BodilyMentalStatus
		//*********************************************************************
		/// <summary>
		/// Method Name : SearchDataBodilyMentalStatus
		/// Called By : FrmActiveReport
		/// Date       : 10/2/2007
		/// </summary>
		/// <param name="intRepID"></param>
		...
		/// <returns></returns>
		/// *********************************************************************
		public DS_Rep_BodilyMentalStatus SearchDataBodilyMentalStatus(
			int intRepID,
			byte bytRegion,
			int intUniqueCode,
			string strFromEmployeeDate,
			...
			)
		{
			if (intRepID == (int)enumRepKind.Rep_WorkBook)
			{
				try 
				{
					ocDS_Rep_BodilyMentalStatus = objDAReport.QueryBodilyMentalStatus(bytRegion, intUniqueCode, strFromEmployeeDate, strToEmployeeDate, intSubContractor, intEmployeeStatus, intStudyStatus, intOrgUnit, strJob);

					return ocDS_Rep_BodilyMentalStatus;
				}
				catch( Exception ocException)
				{
					if (ocException is System.Data.SqlClient.SqlException)
		...
		#endregion Rep_BodilyMentalStatus

		#region DS_Rep_Eulogy
		//*********************************************************************
		/// <summary>
		/// Method Name : SearchDataEulogy
		/// Called By : FrmActiveReport
		/// Date       : 10/2/2007
		/// </summary>
		/// <param name="intRepID"></param>
		...
		/// <returns></returns>
		/// *********************************************************************
		public DS_Rep_Eulogy SearchDataEulogy(
			int intRepID,
			byte bytRegion,
			int intUniqueCode,
			string strFromEmployeeDate,
			...
			)
		{
			if (intRepID == (int)enumRepKind.Rep_WorkBook)
			{
				try 
				{
					ocDS_Rep_Eulogy = objDAReport.QueryEulogy(bytRegion, intUniqueCode, strFromEmployeeDate, strToEmployeeDate, intSubContractor, intEmployeeStatus, intStudyStatus, intOrgUnit, strJob);

					return ocDS_Rep_Eulogy;
				}
				catch( Exception ocException)
				{
					if (ocException is System.Data.SqlClient.SqlException)
		...
		#endregion Rep_Eulogy

		#region DS_Rep_Score
		//*********************************************************************
		/// <summary>
		/// Method Name : SearchDataScore
		/// Called By : FrmActiveReport
		/// Date       : 10/2/2007
		/// </summary>
		/// <param name="intRepID"></param>
		...
		/// <returns></returns>
		/// *********************************************************************
		public DS_Rep_Score SearchDataScore(
			int intRepID,
			byte bytRegion,
			int intUniqueCode,
			string strFromEmployeeDate,
			...
			)
		{
			if (intRepID == (int)enumRepKind.Rep_WorkBook)
			{
				try 
				{
					ocDS_Rep_Score = objDAReport.QueryScore(bytRegion, intUniqueCode, strFromEmployeeDate, strToEmployeeDate, intSubContractor, intEmployeeStatus, intStudyStatus, intOrgUnit, strJob);

					return ocDS_Rep_Score;
				}
				catch( Exception ocException)
				{
					if (ocException is System.Data.SqlClient.SqlException)
		...
		#region DS_Rep_PersonelTraining
		//*********************************************************************
		/// <summary>
		/// Method Name : SearchDataPersonelTraining
		/// Called By : FrmActiveReport
		/// Date       : 10/2/2007
		/// </summary>
		/// <param name="intRepID"></param>
		...
		/// <returns></returns>
		/// *********************************************************************
		public DS_Rep_PersonelTraining SearchDataPersonelTraining(
			int intRepID,
			byte bytRegion,
			int intUniqueCode,
			string strFromEmployeeDate,
			...
			)
		{
			if (intRepID == (int)enumRepKind.Rep_WorkBook)
			{
				try 
				{
					ocDS_Rep_PersonelTraining = objDAReport.QueryPersonelTraining(bytRegion, intUniqueCode, strFromEmployeeDate, strToEmployeeDate, intSubContractor, intEmployeeStatus, intStudyStatus, intOrgUnit, strJob);

					return ocDS_Rep_PersonelTraining;
				}
				catch( Exception ocException)
				{
					if (ocException is System.Data.SqlClient.SqlException)
		...
		#endregion Rep_PersonelTraining

		#region DS_Rep_SumScore
		//*********************************************************************
		/// <summary>
		/// Method Name : SearchDataSumScore
		/// Called By : FrmActiveReport
		/// Date       : 10/2/2007
		/// </summary>
		/// <param name="intRepID"></param>
		...
		/// <param name="strFromEmployeeDate"></param>
		/// <param name="strToEmployeeDate"></param>
		/// <param name="intSubContractor"></param>
		/// <param name="intEmployeeStatus"></param>
		/// <param name="intStudyStatus"></param>
		/// <param name="intOrgUnit"></param>
		/// <param name="strJob"></param>
		/// <param name="intFromSumPositiveScore"></param>
		/// <param name="intToSumPositiveScore"></param>
		/// <param name="intFromSumNegativeScore"></param>
		/// <param name="intToSumNegativeScore"></param>
		/// <returns></returns>
		/// *********************************************************************
		public DS_Rep_SumScore SearchDataSumScore(
			            int intRepID,
                        string[] arrayRegion,
            int intUniqueCode,
            string strFromEmployeeDate,
			...
			int intFromSumPositiveScore,
			int intToSumPositiveScore,
			int intFromSumNegativeScore,
			int intToSumNegativeScore



			)
		{
			if ( intRepID == (int)enumRepKind.Rep_WorkBook_SumScore )
			{
				try 
				{
                    ocDS_Rep_SumScore = objDAReport.QuerySumScore(arrayRegion, intUniqueCode, strFromEmployeeDate, strToEmployeeDate, arraySubContractor, arrayEmployeeStatus, arrayStudyStatus, arrayOrgUnit, arrayJob, intFromSumPositiveScore, intToSumPositiveScore, intFromSumNegativeScore, intToSumNegativeScore);

					return ocDS_Rep_SumScore;
				}
				catch( Exception ocException)
				{
					if (ocException is System.Data.SqlClient.SqlException)
		...
		#endregion DS_Rep_SumScore

		#region DS_Rep_WorkBookPersonelAccident
		//*********************************************************************
		/// <summary>
		/// Method Name : SearchDataWorkBookPersonelAccident
		/// Called By : FrmActiveReport
		/// Date       : 10/2/2007
		/// </summary>
		/// <param name="intRepID"></param>
		...
		/// <param name="strFromEmployeeDate"></param>
		/// <param name="strToEmployeeDate"></param>
		/// <param name="intContractor"></param>
		/// <param name="intEmployeeStatus"></param>
		/// <param name="intStudyStatus"></param>
		/// <param name="intOrgUnit"></param>
		/// <param name="strJob"></param>
		/// <param name="bytForfeitKind"></param>
		/// <param name="strFromAccidentDate"></param>
		/// <param name="strToAccidentDate"></param>
		/// <returns></returns>
		/// *********************************************************************
		public DS_Rep_WorkBookPersonelAccident SearchDataWorkBookPersonelAccident(
			int intRepID,
            ...
            string[] arrayOrgUnit,
            string[] arrayJob,
			short shrForfeitKind,
			string strFromAccidentDate,
			string strToAccidentDate
			)
		{
			if ( intRepID == (int)enumRepKind.Rep_WorkBook_Accident)
			{
				try 
				{
                    ocDS_Rep_WorkBookPersonelAccident = objDAReport.QueryWorkBookPersonelAccident(arrayRegion, intUniqueCode, strFromEmployeeDate, strToEmployeeDate, arraySubContractor, arrayEmployeeStatus, arrayStudyStatus, arrayOrgUnit, arrayJob, shrForfeitKind, strFromAccidentDate, strToAccidentDate);

					return ocDS_Rep_WorkBookPersonelAccident;
				}
				catch( Exception ocException)
				{
					if (ocException is System.Data.SqlClient.SqlException)
		...
		#endregion DS_Rep_WorkBookPersonelAccident

		#region DS_Rep_WorkBookPersonelBodilyMentalStatus
		//*********************************************************************
		/// <summary>
		/// Method Name : SearchDataWorkBookPersonelAccident
		/// Called By : FrmActiveReport
		...
		/// <param name="intOrgUnit"></param>
		/// <param name="strJob"></param>
		/// <param name="shrHealthKind"></param>
		/// <param name="strFromCheckupDate"></param>
		/// <param name="strTocheckupDate"></param>
		/// <returns></returns>
		/// *********************************************************************
		public DS_Rep_WorkBookPersonelBodilyMentalStatus SearchDataWorkBookPersonelBodilyMentalStatus(
			int intRepID,
            string[] arrayRegion,
            int intUniqueCode,
            string strFromEmployeeDate,
            ...
            string[] arrayOrgUnit,
            string[] arrayJob,
			string strFromCheckupDate,
			string strTocheckupDate,
			short shrHealthKind
			)
		{
			if ( intRepID == (int)enumRepKind.Rep_WorkBook_PersonelBodilyMentalStatus)
			{
				try 
				{
                    ocDS_Rep_WorkBookPersonelBodilyMentalStatus = objDAReport.QueryWorkBookPersonelBodilyMentalStatus(arrayRegion, intUniqueCode, strFromEmployeeDate, strToEmployeeDate, arraySubContractor, arrayEmployeeStatus, arrayStudyStatus, arrayOrgUnit, arrayJob, strFromCheckupDate, strTocheckupDate, shrHealthKind);

					return ocDS_Rep_WorkBookPersonelBodilyMentalStatus;
				}
				catch( Exception ocException)
				{
					if (ocException is System.Data.SqlClient.SqlException)
		...
		#region DS_Rep_WorkBook_ScoreChartRegion
		//*********************************************************************
		/// <summary>
		/// Method Name : SearchDataWorkBook_ScoreChartRegion
		/// Called By : FrmActiveReport
		/// Date       : 10/2/2007
		/// </summary>
		/// <param name="intRepID"></param>
		...
		/// <returns></returns>
		/// *********************************************************************
		public DS_Rep_WorkBook_ScoreChartRegion SearchDataWorkBook_ScoreChartRegion(
			int intRepID,
            string[] arrayRegion,
            string[] arraySubContractor,
            string[] arrayEmployeeStatus,
		...
		{
			if ( intRepID == (int)enumRepKind.Rep_WorkBook_ScoreChartByRegion)
			{
				try 
				{
                    ocDS_Rep_WorkBook_ScoreChartRegion = objDAReport.QueryWorkBook_ScoreChartRegion(arrayRegion, arraySubContractor, arrayEmployeeStatus, arrayStudyStatus, arrayOrgUnit, arrayJob);

					return ocDS_Rep_WorkBook_ScoreChartRegion;
				}
				catch( Exception ocException)
				{
					if (ocException is System.Data.SqlClient.SqlException)
		...
		#endregion DS_Rep_WorkBook_ScoreChartRegion

		#region DS_Rep_WorkBook_ScoreChartJob
		//*********************************************************************
		/// <summary>
		/// Method Name : SearchDataWorkBook_ScoreChartJob
		/// Called By : FrmActiveReport
		/// Date       : 10/2/2007
		/// </summary>
		/// <param name="intRepID"></param>
		...
		/// <returns></returns>
		/// *********************************************************************
		public DS_Rep_WorkBook_ScoreChartJob SearchDataWorkBook_ScoreChartJob(
			int intRepID,
            string[] arrayRegion,
            string[] arraySubContractor,
            string[] arrayEmployeeStatus,
		...
		{
			if ( intRepID == (int)enumRepKind.Rep_WorkBook_ScoreChartByJob)
			{
				try 
				{
                    ocDS_Rep_WorkBook_ScoreChartJob = objDAReport.QueryWorkBook_ScoreChartJob(arrayRegion, arraySubContractor, arrayEmployeeStatus, arrayStudyStatus, arrayOrgUnit, arrayJob);

					return ocDS_Rep_WorkBook_ScoreChartJob;
				}
				catch( Exception ocException)
				{
					if (ocException is System.Data.SqlClient.SqlException)
		...
		#endregion DS_Rep_WorkBook_ScoreChartJob
	
		#region DS_Rep_WorkBook_ScoreChartStudyStatus
		//*********************************************************************
		/// <summary>
		/// Method Name : SearchDataWorkBook_ScoreChartStudyStatus
		/// Called By : FrmActiveReport
		/// Date       : 10/2/2007
		/// </summary>
		/// <param name="intRepID"></param>
		...
		/// <returns></returns>
		/// *********************************************************************
		public DS_Rep_WorkBook_ScoreChartStudyStatus SearchDataWorkBook_ScoreChartStudyStatus(
			int intRepID,
            string[] arrayRegion,
            string[] arraySubContractor,
            string[] arrayEmployeeStatus,
		...
		{
			if ( intRepID == (int)enumRepKind.Rep_WorkBook_ScoreChartByEducation)
			{
				try 
				{
                    ocDS_Rep_WorkBook_ScoreChartStudyStatus = objDAReport.QueryWorkBook_ScoreChartStudyStatus(arrayRegion, arraySubContractor, arrayEmployeeStatus, arrayStudyStatus, arrayOrgUnit, arrayJob);

					return ocDS_Rep_WorkBook_ScoreChartStudyStatus;
				}
				catch( Exception ocException)
				{
					if (ocException is System.Data.SqlClient.SqlException)
		...
		#endregion DS_Rep_WorkBook_ScoreChartStudyStatus
	
		#region DS_Rep_WorkBook_ScoreChartEmployeeStatus
		//*********************************************************************
		/// <summary>
		/// Method Name : SearchDataWorkBook_ScoreChartEmployeeStatus
		/// Called By : FrmActiveReport
		/// Date       : 10/2/2007
		/// </summary>
		/// <param name="intRepID"></param>
		...
		/// <returns></returns>
		/// *********************************************************************
		public DS_Rep_WorkBook_ScoreChartEmployeeStatus SearchDataWorkBook_ScoreChartEmployeeStatus(
			int intRepID,
            string[] arrayRegion,
            string[] arraySubContractor,
            string[] arrayEmployeeStatus,
		...
		{
			if ( intRepID == (int)enumRepKind.Rep_WorkBook_ScoreChartByEmployeeKind)
			{
				try 
				{
                    ocDS_Rep_WorkBook_ScoreChartEmployeeStatus = objDAReport.QueryWorkBook_ScoreChartEmployeeStatus(arrayRegion, arraySubContractor, arrayEmployeeStatus, arrayStudyStatus, arrayOrgUnit, arrayJob);

					return ocDS_Rep_WorkBook_ScoreChartEmployeeStatus;
				}
				catch( Exception ocException)
				{
					if (ocException is System.Data.SqlClient.SqlException)
		...
		#endregion DS_Rep_WorkBook_ScoreChartEmployeeStatus
