...
namespace Shayatech
{
    public class MvcApplication : System.Web.HttpApplication
    {
        ...
        protected void Session_Start(object sender, EventArgs e)
        {
            ...
            Session[GeneralModule.m_CurrentUser] = new AppUser { UserName = "guest", AllowWriteBlog = false, AllowWriteImage = false ,IsActive=true, HighPermission=false, UserDes="کاربر مهمان", UserId=0};
