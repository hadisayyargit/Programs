var App = function () {
    ...
    var handleChat = function () {
        ...
        var handleClick = function () {
            ...
            var tpl = '';
            tpl += '<li class="out">';
            tpl += '<img class="avatar" alt="" src="images/avatar1.png"/>';
    ...
    var handleMainMenu2 = function () {
        jQuery('#sidebar .has-sub2 > a').click(function () {
            var last = jQuery('.has-sub2.open', $('#sidebar'));
            last.removeClass("open");
            jQuery('.arrow', last).removeClass("open");
            jQuery('.sub2', last).slideUp(200);
            var sub = jQuery(this).next();
            if (sub.is(":visible")) {
                jQuery('.arrow', jQuery(this)).removeClass("open");
                jQuery(this).parent().removeClass("open");
    ...
    var handleStyler = function () {
        ...
        var setColor = function (color) {
            //alert(color)
            //$('#style_color').attr("href", "Content/style_" + color + ".css");
            $('#style_color').attr("href", "/Content/style_" + color + ".css");
        }
    ...
    return {
        ...
        init: function () {
            ...
            handleMainMenu2(); // handles main menu
