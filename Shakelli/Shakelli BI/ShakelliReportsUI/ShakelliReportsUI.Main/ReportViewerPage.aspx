<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportViewerPage.aspx.cs" Inherits="ShakelliReportsUI.Main.ReportViewerPage" %>
...
<form id="form1" runat="server">
     ...
     <asp:ScriptManager ID="scriptManager" runat="server" EnablePartialRendering="true"/>    
        <rsweb:ReportViewer ID="ReportViewerControl1" runat="server" Width="100%" Height="600px">           
        </rsweb:ReportViewer>
    ...
    function pageLoad() {
        ...
        if (!$("#ff_print").length) {
                    ...
                    try {
                        ...
                        var outerDiv = '<div style="display: inline; font-size: 12px; height: 30px;" class=" "><table cellspacing="0" cellpadding="0" style="display: inline;"><tbody><tr><td height="28px">' + innerTable + '</td></tr></tbody></table></div>';
