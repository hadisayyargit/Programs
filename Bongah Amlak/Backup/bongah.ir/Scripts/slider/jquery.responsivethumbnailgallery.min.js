...
(function($) {
    ...
    $.ThumbnailGallery = function(el, options) {
        ...
        var defaults = {
            thumbImages: 'Images/property/'+$pageTitle+'/thumbs/image',
            smallImages: 'Images/property/'+$pageTitle+'/large/image',
            largeImages: 'Images/property/'+$pageTitle+'/large/image',
            count: $imgCount,
            thumbImageType: 'jpg',
            breakpoint: 600,
            imageType: 'jpg',
        ...
        function updateMainImage(imageNumber) {
            ...
            $("<Images/>") // Make in memory copy of image to avoid css issues
